 ...
 * Useful for injecting e.g. X-Share-Token for the unit share feature.
...
export async function customFetch<T = unknown>(
  ...
  const headers = mergeHeaders(isRequest(input) ? input.headers : undefined, headersInit, _extraHeaders);
