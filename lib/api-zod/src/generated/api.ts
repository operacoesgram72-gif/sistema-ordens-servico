...
export const ListServiceOrdersResponseItem = zod.object({
  ...
  "status": zod.enum(['aberta', 'em_andamento', 'concluida', 'cancelada', 'impedimento']),
  "location": zod.string(),
  ...
  "formatoServico": zod.enum(['civil', 'refrigeracao', 'hidraulica', 'mecanica', 'eletrica', 'ronda', 'outros', 'null']).nullish(),
...
export const UpdateServiceOrderBody = zod.object({
  ...
  "status": zod.enum(['aberta', 'em_andamento', 'concluida', 'cancelada', 'impedimento']).optional(),
